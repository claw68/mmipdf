<p style = "font-size:2em; font-weight: bold;">Top 5</p> 
        <div style = "font-size:1.5em; font-family: Arial; height: 600px;margin-top: -10px;"><table id="grid_male" class="scroll" cellpadding="0" cellspacing="0" style="cursor: pointer; -moz-user-select: none;"></table></div>
...
<p style = "font-size:2em; font-weight: bold;">Top 5</p>         
        <div style = "font-size:1.5em; font-family: Arial; height: 600px;margin-top: -10px;"><table id="grid_female" class="scroll" cellpadding="0" cellspacing="0" style="cursor: pointer; -moz-user-select: none;"></table></div>
        <div class="clearer">&nbsp;</div> 
    ...
    $("#grid_male").jqGrid({
            ...
            datatype: "json",
             colNames:['Candidate Number',<?php foreach($event as $row){?>'<?php echo $row->event_name?>',<?php } ?>'Total','Rank'],
            colModel:[
                    {name:'num',index:'num',align:"center", sortable: true,sorttype:'int'},
                    <?php foreach($event as $row){?>
                    {name:'crit_f_<?php echo $row->event_id?>',index:'crit_f_<?php echo $row->event_id?>',align:"center", sortable: true,sorttype:'int'},
                    <?php } ?>
