...
<?php $this->load->view('event_buttons');?>                              				
...
<div class="entire">
 <div>
      <div style="position:absolute;width:200px;color:#fff;"><h2><?php echo $judge_name?></h2></div>
      <div style="float:right;width:100px;"> <a id="logout" href="mmi_c/logout">Logout</a></div>                              
  </div>  
  <!-- HEADER SECTION -->
  <div class="header">
  ...
  <div class="whole">	
    ...
    <?php for($i=1;$i<=$countCont/2;$i++){?>  
  	   <div style="margin-top:25px" id="cont_id<?php echo $i?>" class="num_pad">
